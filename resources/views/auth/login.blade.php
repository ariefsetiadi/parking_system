                            ...
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="{{ route('postLogin') }}">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user @error('officer_number') is-invalid @enderror" id="officer_number" name="officer_number" placeholder="Masukkan Nomor Petugas">
